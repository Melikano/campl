...
type instance
  XECall MplTypeChecked =
    XMplType MplTypeChecked

type instance
  XEObjCall MplTypeChecked =
...
type instance
  XEUnfoldPhrase MplTypeChecked =
    ()

type instance
  XEUnfoldSubPhrase MplTypeChecked =
...
type instance
  XPRecord MplTypeChecked =
    (Location, XMplType MplTypeChecked)

type instance
  XPRecordPhrase MplTypeChecked =
    -- (MplTypePhrase MplTypeChecked (SeqObjTag CodataDefnTag), XMplType MplTypeChecked)
    MplTypePhrase MplTypeChecked (SeqObjTag CodataDefnTag)
...
type instance
  XTypePhraseTo MplTypeChecked t =
    XMplType MplTypeChecked

type instance
  XTypePhraseFrom MplTypeChecked (SeqObjTag DataDefnTag) =
    [XMplType MplTypeChecked]

type instance
  XTypePhraseFrom MplTypeChecked (SeqObjTag CodataDefnTag) =
    ([XMplType MplTypeChecked], XMplType MplTypeChecked) -- args ++ [statevar] State var must be the last variable

type instance
  XTypePhraseFrom MplTypeChecked (ConcObjTag ProtocolDefnTag) =
    XMplType MplTypeChecked

type instance
  XTypePhraseFrom MplTypeChecked (ConcObjTag CoprotocolDefnTag) =
    XMplType MplTypeChecked

-- Function / process type
type instance
  XFunType MplTypeChecked =
...
type instance
  XTypeConcWithArgs MplTypeChecked =
...
type instance
  XTypeVar MplTypeChecked =
    Maybe (XMplKind MplTypeChecked)

type instance
  XTypeWithNoArgs MplTypeChecked =
