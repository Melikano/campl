...
instance Print MplLanguage.AbsMPL.ClassProp where
  prt i = \case
    MplLanguage.AbsMPL.PROC_CLASS_PROP procclassprop -> prPrec i 0 (concatD [prt 0 procclassprop])
    MplLanguage.AbsMPL.FUN_CLASS_PROP funclassprop -> prPrec i 0 (concatD [prt 0 funclassprop])
...
instance Print MplLanguage.AbsMPL.SuperClasses where
  prt i = \case
    MplLanguage.AbsMPL.SUPER_CLASSES_SEQ typeconstraints -> prPrec i 0 (concatD [prt 0 typeconstraints])
    MplLanguage.AbsMPL.SUPER_CLASSES_CONC typeconstraints1 typeconstraints2 -> prPrec i 0 (concatD [prt 0 typeconstraints1, doc (showString "|"), prt 0 typeconstraints2])

instance Print MplLanguage.AbsMPL.TypeClassDefn where
  prt i = \case
    MplLanguage.AbsMPL.TYPECLASS_DEFN typeconstraint classprops -> prPrec i 0 (concatD [doc (showString "class"), prt 0 typeconstraint, doc (showString "where"), doc (showString "{"), prt 0 classprops, doc (showString "}")])
    MplLanguage.AbsMPL.TYPECLASS_SUPERCLASS_DEFN superclasses typeconstraint classprops -> prPrec i 0 (concatD [doc (showString "class"), prt 0 superclasses, doc (showString "=>"), prt 0 typeconstraint, doc (showString "where"), doc (showString "{"), prt 0 classprops, doc (showString "}")])
...
instance Print MplLanguage.AbsMPL.TypeClassInstanceDefn where
  prt i = \case
    ...
    MplLanguage.AbsMPL.TYPECLASS_INSTANCE_DEPENDENCY_DEFN superclasses typeconstraint classpropdefns -> prPrec i 0 (concatD [doc (showString "instance"), prt 0 superclasses, doc (showString "=>"), prt 0 typeconstraint, doc (showString "where"), doc (showString "{"), prt 0 classpropdefns, doc (showString "}")])
